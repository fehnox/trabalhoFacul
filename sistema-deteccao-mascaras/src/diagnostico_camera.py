<!-- filepath: c:\Users\Admin\Documents\GitHub\trabalhoFacul\CONTRIBUICAO.md -->
<div align="center">

# 🤝 Contribuição para o Sistema Inteligente de Detecção de Máscaras

**Agradecemos seu interesse em contribuir para o nosso projeto!** Aqui estão algumas diretrizes e informações sobre como você pode ajudar.
